...
public class enterDataFrame extends JFrame implements ActionListener
{
  ...
  JButton preprocess = new JButton("Procesar");
  ...
  public enterDataFrame(SimplexTool target, String title, int numVariables,
			int numConstraints)
    {
      ...
      minmax.addItem("Minimizar");
      minmax.addItem("Maximizar");
	...
	(dataPanel, new JLabel((String)"x"+(col+1),JLabel.LEFT),
	 ...
	 0.0, 0.0, 0, 0, 0, 0);
      ...
      outerParent.constrain
	(dataPanel, new JLabel((String)"Sujeto a:",JLabel.LEFT),
	 0, 2, width, 1,
	 GridBagConstraints.NONE, GridBagConstraints.WEST,
	 0.0, 0.0, 10, 0, 10, 0);
  ...
  public void actionPerformed(ActionEvent e)
	...
	if (e.getSource() ==  reset) {
	  ...
	  outerParent.dataFrame.Messages.setText("Preciona el boton Procesar para ejecutar.");
	}
